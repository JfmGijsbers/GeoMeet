...
public class CreateMeetingAPICall extends AbstractCommandingAPICall {
    private final static String CALL_URL = BASE_URL + "/api/meeting/create.php";
    private final RequestParams params;

    public CreateMeetingAPICall(AuthenticationManager authenticationManager,
